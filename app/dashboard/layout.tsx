...
export default async function DashboardLayout({
  ...
  const recruiterNav = [
    { name: "Recruiter Dashboard", href: "/dashboard/recruiter", iconName: "Users" },
  ];
  ...
  return (
    <div className="flex h-screen w-full bg-zinc-950 text-zinc-100">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* Main Body */}
        <main className="flex-1 overflow-y-auto bg-gradient-to-b from-zinc-950 to-zinc-900/20 p-8 custom-scrollbar">
          {children}
        </main>
      </div>
